...
<div class="row py-1">
          ...
          <div class="col-md-8 offset-md-2">
            ...
            <fieldset class="form-group border p-3">
              ...
              <form action="/edit/bookupdated" method="post" id="enrollment-form" >
                <div class="row mb-3">
                  <div class="col-3 col-md-4 text-start">
                    <label for="" class="form-label">Book Code</label>
                  </div>
                  <div class="col-9 col-md-8 text-center">
                    <input type="text" readonly class="form-input m-0 w-100 rounded border-1" value="${data.getBookcode()}" name="bookcode" required/>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-3 col-md-4 text-start">
                  ...
                  <div class="col-9 col-md-8 text-center">
                    <input type="text" class="form-input m-0 w-100 rounded border-1" value="${data.getBookname()}" name="bookname" required/>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-9 col-md-8 text-center">
                      <input type="date" class="form-input m-0 w-100 rounded border-1" value="${data.getDate()}" name="date" required/>
                  </div>
                </div>
